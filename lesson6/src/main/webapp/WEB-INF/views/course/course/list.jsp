...
<lesson:page title="course.title.list">
                    ...
                    <div class="col-xs-12">
                        ...
                        <table id="simple-table" class="table  table-bordered table-hover">
                            ...
                            <tr> 
                                ...
                                <th class="hidden-md hidden-sm hidden-xs"><spring:message code="course.description"/></th>
                            ...
                            <c:forEach items="${course}" var="course">
                                <tr id="tr-${course.id}">
                                    ...
                                    <td class="hidden-md hidden-sm hidden-xs">${course.description}</td>
                                    <td class="center">
                                        ...
                                        <div class="hidden-md hidden-lg">
                                            <div class="inline pos-rel">
                                                ...
                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                    ...
                                                    <li>
                                                        <a href="course/course/manage/mainMenus/detail.do?id=${course.id}">
                                                    ...
                                                    <li>
                                                        <a data-id="${course.id}"
                                                           data-url="/course/course/save_delete.do" class="red btn-delete-modal">
                                            ...
                                            <div class="profile-user-info profile-user-info-striped">
                                                <div class="profile-info-row">
                                                    ...
                                                    <div class="profile-info-value">
                                                        <span><c:out value="${course.description}"/></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
